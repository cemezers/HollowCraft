...
import fan.teamchery.hollowknight.procedures.GhostPriGibieliSushchnostiProcedure;
...
public class GhostEntity extends Monster implements IAnimatable {
	...
	public GhostEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HollowknightModEntities.GHOST.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, RadianceEntity.class, false, false));
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, EntityPlagueEntity.class, false, false));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(HollowknightModItems.BROKEN_GHOST_HEAD.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		GhostPriGibieliSushchnostiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public static void init() {
		SpawnPlacements.register(HollowknightModEntities.GHOST.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
